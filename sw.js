/* ============================================================
   ...
   v21 bump: Phase 6C step 7 (track-dominance per-tab module) —
   track-dominance now lives in /standings/tabs/track-dominance.min.js
   instead of the legacy bundle. The orchestrator owns its URL state
   (trackSession + trackTeamA + trackTeamB) end-to-end, and the updated
   slim entry can land directly on the track-dominance tab without paying
   for the legacy chunk first. Bump ensures returning sessions drop the old
   v20 shell cache and fetch the new standings entry plus the standalone tab
   module from f1s-assets-v21.
...
var SW_VERSION    = 'v21';
var CACHE_SHELL   = 'f1s-shell-v21';
var CACHE_PAGES   = 'f1s-pages-v21';
var CACHE_ASSETS  = 'f1s-assets-v21';
var CACHE_DATA    = 'f1s-data-v21';
