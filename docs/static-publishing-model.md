...
- `node_modules/`
- `dist/`
- `*.min.css`, `*.min.js`, `scripts/build/asset-manifest.json`, `styles/vendor/bootstrap.slim.css`, `images/icons/sprite.svg` (rebuilt by `npm run build:assets` on every build, including CI)
